...
It uses Next.js with Nextra theme for frontend, Graphql for api and MongoDB for database. You can checkout nextra here and source code here.

### I can't find my favorite show or quote.

Well that's the question left to figure out. i was thinking of opening git issue and start accepting requests there, I'm open for suggestions.
